...
import { getParametersForUnsplash } from '../list/Post';
  ...
  return (
    <Templates>
      ...
      {/* 
        ...
        */}
      <PostImage src={`${post?.image}${getParametersForUnsplash({ width: 1536, height: 1056, quality: 80, format: 'jpg' })}`} alt='thumnail' />
